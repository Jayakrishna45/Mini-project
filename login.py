...
class Login:
    def __init__(self,root):
        self.root=root
        self.root.title("Examination Management with Face Recognition")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            messagebox.showinfo("Sussessfully","Welcome to Examination Management with Face Recognition")
        else:
...
class Face_Recognition_System:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1530x790+0+0")
        self.root.title("Examination Management System with Face Recognition")

# This part is image labels setting start 
        # first header image  
        img=Image.open(r"Images_GUI\banner.jpg")
        img=img.resize((1530,135),Image.ANTIALIAS)
        ...
        bg1=bg1.resize((1530,795),Image.ANTIALIAS)
        ...
        #title section
        title_lb1 = Label(bg_img,text="Detection of Impersonation in Examination",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        std_b1.place(x=290,y=100,width=180,height=180)
        ...
        std_b1_1.place(x=290,y=280,width=180,height=45)
        ...
        att_b1.place(x=750,y=100,width=180,height=180)

        att_b1_1 = Button(bg_img,command=self.attendance_pannel,text="Exam Report",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=750,y=280,width=180,height=45)
        ...
        tra_b1.place(x=290,y=330,width=180,height=180)

        tra_b1_1 = Button(bg_img,command=self.train_pannels,text="Data Train",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        tra_b1_1.place(x=290,y=510,width=180,height=45)

        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\bg.png")
