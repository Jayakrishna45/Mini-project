...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Exam Report Pannel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        main_frame.place(x=80,y=55,width=1355,height=510)
        ...
        #Attendance
        student_attend_label = Label(left_frame,text="Exam-status:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
