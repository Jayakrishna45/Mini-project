...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1530,height=135)
        ...
        dep_combo["values"]=("Select Department","CSE","ISE","MCA","AIDS","ECE")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","OE","SSCD","OS","CN","DSA","Maths","AI","C++","JAVA")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2017-18","2018-19","2020-21","2021-22","2023-24")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Exam Division:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Proctor Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
