...
# This part is image labels setting start 
       ...
       # std_b1_1.place(x=250,y=380,width=180,height=45)
        ...
        det_b1.place(x=570,y=200,width=180,height=180)

        det_b1_1 = Button(bg_img,text="JayaKrishna A",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=570,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"Images_GUI\det1.jpg")
        att_img_btn=att_img_btn.resize((180,180),Image.ANTIALIAS)
        self.att_img1=ImageTk.PhotoImage(att_img_btn)

        att_b1 = Button(bg_img,image=self.att_img1,cursor="hand2",)
        att_b1.place(x=800,y=200,width=180,height=180)

        att_b1_1 = Button(bg_img,text="Kiran Kumar M",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        att_b1_1.place(x=800,y=380,width=180,height=45)
