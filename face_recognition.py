...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        self.root.title("Impersonator Detection Pannel")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Impersonation Detection Pannel",font=("verdana",30,"bold"),bg="white",fg="navyblue")
